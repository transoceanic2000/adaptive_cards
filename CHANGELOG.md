...
- Support for Image element of Adaptive Cards
- Support for specifying string enum option values using Ruby symbols, which will be automatically camelCased, e.g. specify `spacing: :extra_large` will be converted to `'spacing' : 'extraLarge'` in the hash.
